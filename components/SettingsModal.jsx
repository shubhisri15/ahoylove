...
export default function SettingsModal({onClose}) {
    return (
        <div className="bg-white text-black p-8 absolute z-100 w-2/5 h-3/5 rounded-xl flex flex-col items-center justify-between top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <img src={logo} alt='Ahoylove logo' className='w-40'/>
            <form className='w-full grid grid-cols-2 justify-between gap-4 max-w-xl'>
